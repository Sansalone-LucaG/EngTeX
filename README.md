# 🚀 EngTeX — Professional LaTeX Templates Suite

🇬🇧 **ENGLISH**
Welcome to the EngTeX ecosystem! This repository contains the documentation and manuals for professional LaTeX templates optimized for STEM disciplines.
...
🇮🇹 **ITALIANO**
Benvenuto nell'ecosistema EngTeX! Questa repository contiene la documentazione e i manuali dei template LaTeX professionali ottimizzati per le discipline STEM.
